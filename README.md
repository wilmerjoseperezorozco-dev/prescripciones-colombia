...
- **Transparencia**: toda afirmación legal debe citar la norma, artículo o sentencia exacta. Ninguna cifra o plazo se publica sin fuente verificada.
- **No difamación**: no se nombran entidades financieras, cooperativas o firmas de cobranza específicas salvo que exista evidencia documental sólida y verificada legalmente. La primera versión pública es educativa/general.
- **Reproducibilidad**: cualquier colombiano debe poder tomar este repositorio y aplicar el mismo proceso a su caso.
- **Cero asesoría no verificada**: cuando el caso de un usuario requiera acción legal puntual, se debe remitir a consultorios jurídicos universitarios, Defensoría del Pueblo o abogado, no improvisar.

## Estructura del repositorio

```
├── 00-fase0-planificacion/   # Fase 0: alcance, riesgos, plan de fases
├── docs/                     # Informe público y marco legal
├── recursos-legales/         # Normas, jurisprudencia y fuentes citadas (verificadas)
├── plantillas/                # Derecho de petición, excepción de prescripción, tutela
└── casos-anonimizados/        # Casos de estudio anonimizados que ilustran el patrón
```
